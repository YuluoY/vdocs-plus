    ...
    return function (t) {
        ...
        e.default = {
            ...
            props: {
                ...
                countdownSize: {type: String, required: !1},
            ...
            methods: {
                updateAllCards: function () {
                    ...
                    if (!(t >= this.timeData.length || void 0 === e)) {
                        ...
                        var n = this.timeData[t], i = e < 0 ? 0 : e, a = document.querySelector("#" + n.elementId);
                        if (i !== n.current && (n.previous = n.current, n.current = i, a && (a.classList.remove("flip"), a.offsetWidth, a.classList.add("flip")), 0 === t)) {
                            ...
                            if (r) {
                                var o = !0, d = !1, s = void 0;
                                try {
                                    for (var c, f = r[Symbol.iterator](); !(o = (c = f.next()).done); o = !0) {
                                        var l = c.value, u = l.classList[0];
                                        if (e / 1e3 >= 1) {
        ...
        var d = n(10), s = n(11), c = i, f = Object(s.a)(r.a, d.a, d.b, !1, c, "data-v-cff81de8", null);
        e.default = f.exports
    }, function (t, e, n) {
        var i = n(3);
        ...
        function s(t, e) {
            var n = e.css, i = e.media, a = e.sourceMap;
        ...
        var c = n(6), f = "undefined" != typeof document;
        ...
        var l = {}, u = f && (document.head || document.getElementsByTagName("head")[0]), p = null, v = 0, h = !1,
            m = function () {
            }, b = null, _ = "data-vue-ssr-id",
        ...
        function i(t, e) {
            for (var n = [], i = {}, a = 0; a < e.length; a++) {
                var r = e[a], o = r[0], d = r[1], s = r[2], c = r[3],
                    f = {id: t + ":" + a, css: d, media: s, sourceMap: c};
        ...
        function i(t, e, n) {
            ...
            if (o[6] = 15 & o[6] | 64, o[8] = 63 & o[8] | 128, e) for (var d = 0; d < 16; ++d) e[i + d] = o[d];
            return e || r(o)
        }
        ...
        var i = function () {
            ...
            return n("div", {staticClass: "container flip-clock"}, [t._l(t.timeData, function (e) {
                return [n("span", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                    ...
                    }], key: e.label, staticClass: "flip-clock__piece", attrs: {id: e.elementId}
                }, [n("span", {
                    staticClass: "flip-clock__card flip-card",
                    style: t.countdownSize ? "font-size:" + t.countdownSize : ""
                }, [n("b", {staticClass: "flip-card__top"}, [t._v(t._s(t._f("twoDigits")(e.current)))]), t._v(" "), n("b", {
                    staticClass: "flip-card__bottom",
                    attrs: {"data-value": t._f("twoDigits")(e.current)}
                }), t._v(" "), n("b", {
                    staticClass: "flip-card__back",
                    attrs: {"data-value": t._f("twoDigits")(e.previous)}
                }), t._v(" "), n("b", {
